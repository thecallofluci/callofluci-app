...
export const appConstants = {
  ...
  LATEST_CALLOFLUCI_RELEASE_URL: 'https://api.github.com/repos/thecallofluci/callofluci-website/releases/latest',
  CALLOFLUCI_REPO_STARGAZERS_URL: 'https://api.github.com/repos/thecallofluci/callofluci-website',
}
