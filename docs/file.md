...
| `AppWrapper.tsx`        | /src            | Layout component wrapping main content with header, body, & footer |
| `Body.tsx`              | /src            | Main content container                                             |
| `error.tsx`             | /src            | Custom error page component                                        |
| `Footer.tsx`            | /src            | Footer layout component                                            |
| `Header.tsx`            | /src            | Header layout component                                            |
| `layout.tsx`            | /src            | Root layout component                                              |
| `loading.tsx`           | /src            | Custom loading component                                           |
| `providers.tsx`         | /src            | Wraps the application with necessary context providers             |
